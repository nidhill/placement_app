  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold text-foreground tracking-tight">Audit Logs</h2>
                ...
                filteredLogs.map(log => (
                  <tr key={log.id} className="hover:bg-muted/60 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <span className="font-mono text-slate-800 text-[11px] font-medium bg-muted px-1.5 py-0.5 rounded">
                        {log.action}
                      </span>
                    </td>
